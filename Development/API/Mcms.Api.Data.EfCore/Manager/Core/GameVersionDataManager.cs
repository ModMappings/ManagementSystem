...
namespace Mcms.Api.Data.EfCore.Manager.Core
{
        ...
        : IGameVersionDataManager
    {
        ...
        private readonly ILogger<GameVersionDataManager> _logger;

        public GameVersionDataManager(ICallbackBasedQueryFilterFactory<GameVersion> queryFilterFactory, IStore<GameVersion> store, ILogger<GameVersionDataManager> logger)
        {
