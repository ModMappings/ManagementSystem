...
namespace Mcms.Api.Data.EfCore.Manager.Mapping.Mappings
{
        ...
        : ICommittedMappingDataManager
    {
        ...
        private readonly ILogger<CommittedMappingDataManager> _logger;

        public CommittedMappingDataManager(ICallbackBasedQueryFilterFactory<CommittedMapping> queryFilterFactory, IStore<CommittedMapping> store, ILogger<CommittedMappingDataManager> logger)
        {
