...
{
    public class ProposedMappingManager
        : IProposedMappingManager
    {
        ...
        private readonly ILogger<ProposedMappingManager> _logger;

        public ProposedMappingManager(ICallbackBasedQueryFilterFactory<ProposedMapping> queryFilterFactory, IStore<ProposedMapping> store, ILogger<ProposedMappingManager> logger)
        {
