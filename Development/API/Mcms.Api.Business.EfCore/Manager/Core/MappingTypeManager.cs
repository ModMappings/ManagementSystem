...
namespace Data.EFCore.Manager.Core
{
        ...
        : IMappingTypeManager
    {
        ...
        private readonly ILogger<MappingTypeManager> _logger;

        public MappingTypeManager(ICallbackBasedQueryFilterFactory<MappingType> queryFilterFactory, IStore<MappingType> store, ILogger<MappingTypeManager> logger)
        {
