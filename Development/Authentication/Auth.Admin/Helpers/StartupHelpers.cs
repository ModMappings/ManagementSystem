...
using Auth.Admin.ExceptionHandling;
using Auth.Admin.Middlewares;
using Auth.Admin.Configuration;
using Auth.Admin.Configuration.ApplicationParts;
using Auth.Admin.Configuration.Constants;
using Auth.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Auth.Admin.Helpers.Localization;
...
namespace Auth.Admin.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static IServiceCollection ConfigureRootConfiguration(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.Configure<AdminUserSeedConfiguration>(
                configuration.GetSection(ConfigurationConsts.AdminSeedConfigurationKey));

            services.TryAddSingleton<ISeedConfiguration, SeedConfiguration>();
