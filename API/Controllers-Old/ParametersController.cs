...
namespace API
{
        ...
        CreateVersionedParameterModel>
    {
        ...
        public ParametersController(IComponentWriter readerWriter, IGameVersionReader gameVersionReader, IUserResolvingService userResolvingService, IMethodMappingReader methodMappingReader) : base(readerWriter, gameVersionReader, userResolvingService)
        {
