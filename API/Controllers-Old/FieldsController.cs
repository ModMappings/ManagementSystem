...
namespace API
{
        ...
        CreateVersionedFieldModel>
    {
        ...
        public FieldsController(IComponentWriter readerWriter, IGameVersionReader gameVersionReader, IUserResolvingService userResolvingService, IClassMappingReader classMappingReader) : base(readerWriter, gameVersionReader, userResolvingService)
        {
