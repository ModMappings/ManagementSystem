        ...
        return createPagedStarRequest(
                selectSpecWithJoin -> selectSpecWithJoin
                        ...
                        .where(() -> {
                            ...
                            criteria = nonNullAndLikesCheckForWhere(criteria, mappingInputExpression, "m", "input");
                            criteria = nonNullAndLikesCheckForWhere(criteria, mappingOutputExpression, "m", "output");
