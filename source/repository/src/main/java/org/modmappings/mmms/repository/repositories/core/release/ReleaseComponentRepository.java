...
public class ReleaseComponentRepository extends ModMappingR2DBCRepository<ReleaseComponentDMO> {
     ...
     */
    Flux<ReleaseComponentDMO> findAllByReleaseId(final UUID releaseId, final Pageable pageable)
    {
     ...
     */
    Flux<ReleaseComponentDMO> findAllByMappingId(final UUID mappingId, final Pageable pageable)
    {
        return createSelectWithSingleWhereRequest("mapping_id", mappingId, pageable);
    }
     ...
     */
    Flux<UUID> findAllMappingIdsByReleaseIdForPackage(final UUID releaseId, final Pageable pageable)
    {
        return createFindAllMappingIdsByReleaseIdForTypeRequest(releaseId, MappableTypeDMO.PACKAGE, pageable);
    }
     ...
     */
    Flux<UUID> findAllMappingIdsByReleaseIdForClass(final UUID releaseId, final Pageable pageable)
    {
        return createFindAllMappingIdsByReleaseIdForTypeRequest(releaseId, MappableTypeDMO.CLASS, pageable);
    }
     ...
     */
    Flux<UUID> findAllMappingIdsByReleaseIdForMethod(final UUID releaseId, final Pageable pageable)
    {
        return createFindAllMappingIdsByReleaseIdForTypeRequest(releaseId, MappableTypeDMO.METHOD, pageable);
    }
     ...
     */
    Flux<UUID> findAllMappingIdsByReleaseIdForField(final UUID releaseId, final Pageable pageable)
    {
        return createFindAllMappingIdsByReleaseIdForTypeRequest(releaseId, MappableTypeDMO.FIELD, pageable);
    }
     ...
     */
    Flux<UUID> findAllMappingIdsByReleaseIdForParameter(final UUID releaseId, final Pageable pageable)
    {
        return createFindAllMappingIdsByReleaseIdForTypeRequest(releaseId, MappableTypeDMO.PARAMETER, pageable);
    }
